...
var BADGES = {
  "claude-whisperer": { name: "Claude Whisperer", icon: "\u{1F916}", desc: "Master of Claude Code", tiers: { bronze: 10, silver: 50, gold: 200, platinum: 500, diamond: 1e3 } },
  "time-lord": { name: "Time Lord", icon: "\u23F1\uFE0F", desc: "Master of AI coding time", tiers: { bronze: 10, silver: 50, gold: 200, platinum: 500, diamond: 1e3 } },
  "night-owl": { name: "Night Owl", icon: "\u{1F319}", desc: "Codes when the world sleeps", tiers: { bronze: 10, silver: 50, gold: 100 } },
  "speed-runner": { name: "Speed Runner", icon: "\u26A1", desc: "Fast task completion", tiers: null },
  "test-driven": { name: "Test Driven", icon: "\u{1F9EA}", desc: "Includes tests in sessions", tiers: null },
  "prompt-engineer": { name: "Prompt Engineer", icon: "\u{1F4DD}", desc: "Detailed context in prompts", tiers: null },
  "early-adopter": { name: "Early Adopter", icon: "\u{1F305}", desc: "Among the first StatsCode users", tiers: null },
  "polyglot": { name: "Polyglot", icon: "\u{1F5E3}\uFE0F", desc: "Uses 3+ programming languages", tiers: null },
  "minimalist": { name: "Minimalist", icon: "\u{1F9F9}", desc: "Deleted more lines than added", tiers: null }
};
var TIER_COLORS = {
  diamond: "\u{1F48E}",
  platinum: "\u{1F3C6}",
...
async function main() {
  ...
  if (timestampsResult[0]?.values?.length > 0) {
    ...
    for (let i = 1; i < timestamps.length; i++) {
      ...
      activeMs += Math.min(gap, 5 * 60 * 1e3);
    }
    activeMs += 5 * 60 * 1e3;
    totalHours = activeMs / 36e5;
  }
  ...
  console.log("\u{1F3C6} Your StatsCode Badges");
  console.log("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\n");
  if (earned.length > 0) {
...
`);
  ...
  if (inProgress.length > 0) {
    console.log("\u{1F504} In Progress:\n");
  ...
  console.log("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
  console.log("\u{1F517} statscode.dev/badges");
}
